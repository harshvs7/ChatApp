...
class ProfileViewController: UIViewController {
    ...
    private var actions = [ProfileTableModel]()
    ...
    private func setUpUI() {
        ...
        actions.append(ProfileTableModel(viewModel: .info, title: "Name: \(AppDefaults.shared.name ?? "")", handler: nil))
        actions.append(ProfileTableModel(viewModel: .info, title: "Email: \(AppDefaults.shared.email ?? "")", handler: nil))
        actions.append(ProfileTableModel(viewModel: .logout, title: "Log out", handler: { [weak self] in self?.logoutTapped() }))
...
extension ProfileViewController {
    private func logoutTapped() {
        showAlertTwoButton(with: "Log out", with: "Do you want to logout?", with: "Cancel", with: "Yes", completion: { [weak self] logOut in
...
extension ProfileViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setUp(model: actions[indexPath.row])
        return cell
    }
